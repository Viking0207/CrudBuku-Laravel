...
<body class="p-8 bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
    <div class="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <form action="/admin/buku" method="POST" enctype="multipart/form-data"
            ...
            {{-- Input file gambar (tidak wajib) --}}
            <input type="file" name="gambar" accept="image/*"
                class="border border-blue-300 rounded px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none bg-white" />
                    ...
                    @foreach ($bukus as $buku)
                        <tr class="border-t hover:bg-blue-50 transition">
                            ...
                            <td class="py-2 px-4 flex items-center justify-center space-x-2">
                                <a href="/admin/buku/{{ $buku->id }}/edit" title="Edit Buku"
